...
const DashboardPage = () => {
  ...
  // Toggle function for showing/hiding team members
  const toggleTeamMembers = (teamIndex) => {
  ...
  // Process team summary with showAll state
  const processedTeamSummary = teamSummary.map((team, index) => ({
    ...team,
    showAllMembers: expandedTeams[index] || false
  }));
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                {processedTeamSummary.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {processedTeamSummary.map((team, index) => {
                      const totalMembers = team.members?.length || 0;
                      const showAll = team.showAllMembers;
                          ...
                          {hasMoreMembers && (
                            <div className="mt-4 text-center">
                              <button
                                ...
                                className="text-blue-600 hover:text-blue-800 text-sm font-medium transition duration-200 flex items-center justify-center w-full py-2 border border-gray-200 rounded-lg hover:bg-gray-50"
                              >
                                {showAll ? (
                                  <>
